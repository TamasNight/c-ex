...
$(OBJEVENTGFXDIR)/peoplemedieval/farmer_3_M.4bpp: %.4bpp: %.png 
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/peoplemedieval/player_farmer_M.4bpp: %.4bpp: %.png 
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/peoplemedieval/iacopo.4bpp: %.4bpp: %.png 
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/peoplemedieval/knight_S.4bpp: %.4bpp: %.png 
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/peoplemedieval/elder_F.4bpp: %.4bpp: %.png 
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/peoplemedieval/blacksmith_M.4bpp: %.4bpp: %.png 
	$(GFX) $< $@ -mwidth 2 -mheight 4
$(OBJEVENTGFXDIR)/peoplemedieval/innkeeper_F.4bpp: %.4bpp: %.png 
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/peoplemedieval/farmer_M.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/peoplemedieval/farmer_F.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/peoplemedieval/bandit_M.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/peoplemedieval/bandit_F.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/peoplemedieval/knight_M.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/peoplemedieval/knight_F.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
$(OBJEVENTGFXDIR)/peoplemedieval/player_M.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/peoplemedieval/player_M_running.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
