...
void SetTrickHouseNuggetFlag(void)
{
    ...
    u16 flag = FLAG_HIDDEN_ITEM_PASCOLI_DEL_LAGO_HARD_STONE;
    *specVar = flag;
    FlagSet(flag);
}
...
bool8 UsedPokemonCenterWarp(void)
{
    ...
    {
        MAP_LUNGAVALLE_POKEMON_CENTER_1F,
...
u32 GetMartEmployeeObjectEventId(void)
{
    ...
    {
        { MAP_GROUP(MAP_LUNGAVALLE_MART),     MAP_NUM(MAP_LUNGAVALLE_MART),     LOCALID_OLDALE_MART_CLERK },
