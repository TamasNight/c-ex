...
static const u16 sRegionMap_SpecialPlaceLocations[][2] =
{
    ...
    {MAPSEC_PETALBURG_WOODS,            MAPSEC_PASSO_DI_GIOVE},
    ...
    {MAPSEC_ALTERING_CAVE,              MAPSEC_VALLE_BASSA},
    {MAPSEC_ARTISAN_CAVE,               MAPSEC_VALLE_BASSA},
...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(MAP_PASCOLI_DEL_LAGO), MAP_NUM(MAP_PASCOLI_DEL_LAGO), HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE},
    [MAPSEC_LUNGAVALLE] = {MAP_GROUP(MAP_LUNGAVALLE), MAP_NUM(MAP_LUNGAVALLE), HEAL_LOCATION_LUNGAVALLE},
    ...
    [MAPSEC_VALLE_BASSA] = {MAP_GROUP(MAP_VALLE_BASSA), MAP_NUM(MAP_VALLE_BASSA), HEAL_LOCATION_NONE},
    [MAPSEC_PASSO_DI_GIOVE] = {MAP_GROUP(MAP_PASSO_DI_GIOVE), MAP_NUM(MAP_PASSO_DI_GIOVE), HEAL_LOCATION_NONE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_LITTLEROOT_TOWN:
        return FlagGet(FLAG_VISITED_PASCOLI_DEL_LAGO) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_LUNGAVALLE:
        return FlagGet(FLAG_VISITED_LUNGAVALLE) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_PASCOLI_DEL_LAGO;
