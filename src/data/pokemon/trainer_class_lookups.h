const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_EXPERT_M] = TRAINER_PIC_KNIGHT_M,
    ...
    [FACILITY_CLASS_PKMN_BREEDER_M] = TRAINER_PIC_BANDIT_M,
...
{
    [FACILITY_CLASS_HIKER] = TRAINER_CLASS_FARMER,
    [FACILITY_CLASS_AQUA_GRUNT_M] = TRAINER_CLASS_TEAM_AQUA,
    [FACILITY_CLASS_PKMN_BREEDER_F] = TRAINER_CLASS_BANDIT,
    ...
    [FACILITY_CLASS_EXPERT_M] = TRAINER_CLASS_KNIGHT,
    ...
    [FACILITY_CLASS_EXPERT_F] = TRAINER_CLASS_KNIGHT,
    ...
    [FACILITY_CLASS_PKMN_BREEDER_M] = TRAINER_CLASS_BANDIT,
