...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_LUNGAVALLE] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_VALLE_BASSA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PASSO_DI_GIOVE] = MAPPOPUP_THEME_WOOD,
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_LUNGAVALLE] = MAPPOPUP_THEME_BW_DEFAULT,
    ...
    [MAPSEC_VALLE_BASSA] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_PASSO_DI_GIOVE] = MAPPOPUP_THEME_BW_DEFAULT,
