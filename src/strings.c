...
const u8 gText_Badges[] = _("Grades"); // Unused
...
const u8 gText_MenuOptionPokedex[] = _("Beastiary");
...
//names
const u8 gText_SideQuestName_1[] = _("The journey begins");
const u8 gText_SideQuestName_2[] = _("Shadows in the Woods");
const u8 gText_SideQuestName_3[] = _("The knight way");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("After waking up late, you have to\nget busy helping out on the farm.");
const u8 gText_SideQuestDesc_2[] = _("After defeating the Houndours in the \nBosco Dei Larici, you found a collar...\nCould someone be behind the attack?");
const u8 gText_SideQuestDesc_3[] = _("A knight showed up at the pastures with\norders from the Duke. You must\nfollow him to Forte Giove.");
...
const u8 gText_SideQuestDoneDesc_1[] = _("You managed to save Tauros and\nkick some Houndour butt.");
...
const u8 gText_SideQuestMap3[] = _("Valle Fredda"); // Unused
...
const u8 gText_SubQuest1_Name4[] = _("Farewell Home");
const u8 gText_SubQuest1_Name5[] = _("New Companions");
const u8 gText_SubQuest1_Name6[] = _("Reach the Tavern");
...
const u8 gText_SubQuest1_Desc4[] = _("Pack your things, say goodbye to\neveryone, and meet Saverio outside\nthe Pascolo.");
const u8 gText_SubQuest1_Desc5[] = _("Saverio gave you some Legami and\noffered you a reward if you catch at\nleast two Pokémon.");
const u8 gText_SubQuest1_Desc6[] = _("Saverio left you alone to explore the\nValle Fredda. He is waiting for you at\nthe tavern at the end of the valley.");
