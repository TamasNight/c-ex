...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_BANDIT, TRAINER_ENCOUNTER_MUSIC_FEMALE},
    ...
    {TRAINER_CLASS_KNIGHT, TRAINER_ENCOUNTER_MUSIC_INTENSE},
    ...
    {TRAINER_CLASS_FARMER, TRAINER_ENCOUNTER_MUSIC_HIKER},
