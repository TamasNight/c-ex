...
extern const u8 BattleScript_RogueProtected[];
...
extern const u8 BattleScript_ClericHeals[]; // Tamas Class System
...
extern const u8 BattleScript_DruidPowerPrevents[];
...
extern const u8 BattleScript_RogueActivates[];
